...
async def get_fake_test_url(url, session):
    ...
    headers = Headers(browser="chrome", os="win", headers=True).generate().update({'pragma': 'no-cache',
        'referer': 'https://videouroki.net/', 'authority': 'cse.google.com',
        'sec-fetch-dest': 'script',
        'sec-fetch-mode': 'no-cors',
        'sec-fetch-site': 'cross-site',})
    ...
    search_url = f'https://cse.google.com/cse/element/v1?rsz=filtered_cse&num=10&hl=ru&source=gcsc&gss=.com&cselibv=c20e9fb0a344f1f9&cx=002726216306166405977:gcagx71gt_c&q={test_title}&safe=off&cse_tok=ALwrddHJmfJF5mP-4xx0Kl38mgX7:1674799158435&sort=&exp=csqr,cc&callback=google.search.cse.api18418'
